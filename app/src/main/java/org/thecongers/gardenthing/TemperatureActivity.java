...
public class TemperatureActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Cursor cursor = database.selectRecordsByDate("Temperature",predatetime,curdatetime);
            ...
            do {
                try {
                    ...
                    if ( sharedPrefs.getBoolean("prefTemperatureUnit",true) ){
                        valueArray[i] = (int) Math.round(convertCtoF(Float.parseFloat(cursor.getString(2))));
                    } else {
